...
### 출력 
 ...
 <p>별의 색을 출력한다. 빨간색이면 "<span style="color: rgb(231, 76, 60); --darkreader-inline-color: #ee5646;" data-darkreader-inline-color=""><code>Red</code></span>", 주황색이면 "<span style="color: rgb(243, 156, 18); --darkreader-inline-color: #faa725;" data-darkreader-inline-color=""><code>Orange</code></span>"<code>,</code> 노란색이면 "<span style="color: rgb(241, 196, 15); --darkreader-inline-color: #f8ce23;" data-darkreader-inline-color=""><code>Yellow</code></span>", 초록색이면 "<span style="color: rgb(39, 174, 96); --darkreader-inline-color: #5adf92;" data-darkreader-inline-color=""><code>Green</code></span>", 파란색이면 "<span style="color: rgb(52, 152, 219); --darkreader-inline-color: #43a3e3;" data-darkreader-inline-color=""><code>Blue</code></span>", 남색이면 "<span style="color: rgb(44, 62, 80); --darkreader-inline-color: #b0c5d7;" data-darkreader-inline-color=""><code>Indigo</code></span>", 보라색이면 "<span style="color: rgb(155, 89, 182); --darkreader-inline-color: #a666bf;" data-darkreader-inline-color=""><code>Violet</code></span>"을 출력한다.</p>
