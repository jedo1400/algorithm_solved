...
### 출력 
 ...
 <p>각 원자 번호를 가진 원소가 인공 합성이 가능한 원소라면 <span style="color: rgb(231, 76, 60); --darkreader-inline-color: #e95849;" data-darkreader-inline-color=""><code>Yes</code></span>, 아니라면 <code><span style="color: rgb(231, 76, 60); --darkreader-inline-color: #e95849;" data-darkreader-inline-color="">No</span></code>를 주어진 순서대로 한 줄에 하나씩 출력한다.</p>
